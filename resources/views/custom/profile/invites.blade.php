                      ...
                      <table class="min-w-full border bg-white">
                        ...
                        <tbody class="divide-y divide-gray-200">
                          ...
                          <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{$invites->invitedBy->name}}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{$invites->invitedBy->email}}</td>

                            <td class="px-6 py-4 whitespace-nowrap">{{$invites->created_at}}</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($invites->is_accept == 0)
                                <a href="accept?invite_id={{$invites->id}}&is_accept=1">
                                   <button class="px-4 py-2 bg-green-500 text-white rounded hover:bg-blue-600">Accept</button>
                                </a>
                                <a href="accept?invite_id={{$invites->id}}&is_accept=2">
                                    <button class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600">Reject</button>
                                 </a>
                                @endif
