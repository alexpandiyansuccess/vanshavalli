                        ...
                        <div class="bg-white rounded-md lg:shadow-md shadow col-span-2 lg:mx-16">
                          ...
                          <div class="grid grid-cols-2 gap-3 lg:p-6 p-4">
                            <div>
                                ...
                                <input type="text" value="{{$userProfile->first_name}}"  name="first_name" placeholder="" class="shadow-none with-border">
                            </div>
                            <div>
                                <label for=""> Last name</label>
                                <input type="text" value="{{$userProfile->last_name}}"  name="last_name" placeholder="" class="shadow-none with-border">
                             </div>
                             <div class="col-span-2">
                                 <label for=""> Email</label>
                                 <input type="email" value="{{$userProfile->email}}"  name="email"
                                 pattern="[A-Za-z0-9._%+-]{3,}@[a-zA-Z]{3,}([.]{1}[a-zA-Z]{2,}|[.]{1}[a-zA-Z]{2,}[.]{1}[a-zA-Z]{2,})"
                                 placeholder="" class="shadow-none with-border">
                             </div>
                             <div class="col-span-2">
                              <label for=""> Contact Number</label>
                              <input  name="contact_number" type="number" pattern="[0-9]*" value="{{$userProfile->contact_number}}" placeholder="" class="shadow-none with-border">
                          </div>
                             <div class="col-span-2">
                                 <label for="about">About me</label>  
                                 <textarea id="about" name="about_me"  rows="3" class="with-border">{{$userProfile->about_me}}</textarea>
                             </div> 
                             
                             <div>
                              <label for=""> Pincode</label>
                              <input type="number" name="pincode" pattern="[0-9]*" value="{{$userProfile->pincode}}" id="zipcode" placeholder="" class="shadow-none with-border">
                          </div>
                          <div>
                              <label for=""> City</label>
                              <input type="text" id="District" name="district" placeholder="" value="{{$userProfile->district}}" class="shadow-none with-border">
                           </div>
                           <div class="col-span-2">
                            <label for=""> State</label>
                            <input type="text" id="State" name="state" placeholder="" value="{{$userProfile->state}}" class="shadow-none with-border">
                        </div>

                             <div>
                                <label for=""> Occupation</label>
                                <input type="text" placeholder="" name="occupation" value="{{$userProfile->occupation}}" class="shadow-none with-border">
                             </div> 
                             <div>
                                
                                <label for=""> Gender </label>
                                <select id="gender" name="gender" class="shadow-none selectpicker with-border" tabindex="-98">
                                  <option @if ($userProfile->gender == 'Male') selected @endif value="Male">Male</option>
                                  <option @if ($userProfile->gender == 'Female') selected @endif value="Female">Female</option>
                                  <option  @if ($userProfile->gender == 'Rather Not Say') selected @endif  value="Rather Not Say">Rather Not Say</option>
                               </select></div>
                             </div>
