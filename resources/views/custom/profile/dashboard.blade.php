...
<head>
    ...
    <link href="{{ asset('css/custom/profile/css/formprofile.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('css/custom/profile/css/custProfile.css')}}">
                                            ...
                                            <div class="col-md-8">
                                              <div class="card mb-3">
                                                <div class="card-body">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-sm-12">
                                                      <a class="btn btn-info " target="__blank" href="">Edit your Profile <i class="bi bi-pencil"></i></a>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
