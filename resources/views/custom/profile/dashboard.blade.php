                        ...
                        <div class="tab-content shadow-none p-0">
                            <div class="page-content">
                                <div class="form-v10-content">
                                    <form class="form-detail" method="POST" action="{{ route('createprofile') }}" id="registrationform"
                                        autocomplete="nope">
                                        @csrf
                                        <div class="form-left">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row form-row-1">
                                                    <input type="text" oninput="this.value = this.value.toUpperCase()"
                                                        name="relationship" inputmode="text" id="relationship" class="input-text"
                                            ...
                                            <div class="form-group">
                                                <div class="form-row form-row-1">
                                                    <input inputmode="email" name="email" type="email"
                                                        ...
                                                        id="email" class="input-text" placeholder="Email" required
                                                        autocomplete="off">
                                                </div>
                                                <div class="form-row form-row-2">
                                                    <input inputmode="tel" name="contact_number" type="number" pattern="[0-9]*"
                                                        inputmode="numeric" id="contact_number" class="business"
