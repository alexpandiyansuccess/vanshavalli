...
<ul class="{{$parent->children->count() > 1 ? 'lines' : '' }}">
  ...
  <li>
    ...
    <img class="child-image {{ $child->color_code }}-border " id="image_1" style="{{$child->secondProfile ? 'left: 18px; !important' : ''}}" src="{{ $child->picture ? asset('profile_images/'.$child->picture) : asset('images/def.jpeg') }}" width="70" >
